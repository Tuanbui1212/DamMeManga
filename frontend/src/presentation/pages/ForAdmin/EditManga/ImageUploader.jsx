...
export default function ImageUploader({ cover, poster, onCoverChange, onPosterChange }) {
  return (
    <div className="space-y-8">
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-3">Ảnh bìa</label>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-3">Poster (nền)</label>
        <div className="relative group">
