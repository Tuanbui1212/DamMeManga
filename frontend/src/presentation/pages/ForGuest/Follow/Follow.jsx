            ...
            <div key={manga.id} className="flex flex-col">
              ...
              <div className="mt-2">
                <a href={`/mangas/${manga.id}`}>
                  <h3 className="font-bold text-sm text-gray-800 line-clamp-2 hover:text-blue-600 transition">
                    {manga.title}
                  </h3>
                </a>
                <h4 className="text-xs text-gray-700 uppercase tracking-wide mt-1">
                  <a
                    ...
                    className="hover:text-blue-600 transition inline-block"
                  >
                    <span className="font-semibold">C. {manga.latestChapter}</span>{" "}
                    - <span>{formatDistanceToNow(manga.updatedAgo, { addSuffix: true, locale: vi })}</span>
                  </a>
                </h4>
              </div>
            </div>
